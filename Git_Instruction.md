...
Для разрешения конфликта нужно выбрать один из четырех вариантов: 
1. Accept Current Change (Принять существующее изменение),
![Accept Current Change](Image-1.jpg)
2. Accept Incoming Change (Принять входящее изменение),
![Accept Incoming Change](Image-2.jpg)
3. Accept Both Changes (Принять оба изменения),
![Accept Both Changes](Image-3.jpg)
4. Compare Changes (Сравнить изменения)
![Compare Changes](Image-4.jpg).

И создать коммит разрешенного конфликта.
